      ...
      <nav className="sticky top-0 z-10 bg-[#0a192f]/90 backdrop-blur-sm border-b border-[#1e3a8a]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            />
            <span className="text-xl font-bold">0ptikube</span>
          </div>
          ...
          <Button
            onClick={() => redirect("https://github.com/oslabs-beta/0ptiKube")}
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-blue-200/80">
              A powerful, intuitive visualization tool that helps you understand
              and manage your Kubernetes clusters with ease.
            </p>
